...
<div class="firstContent">
 ...
 <div class="banner-text">
  ...
  <i class="cursor-pointer fa fa-chevron-down animate__animated animate__heartBeat animate__slower animate__infinite	infinite" aria-hidden="true"></i>
    ...
    <div class="content">
        ...
        <div class="row mb-5 observer_1 flex-column-reverse flex-sm-row">
            <div class="col-xs-12 col-sm-6  ">
             ...
             <div class="col-xs-12 col-sm-6 px-3 px-sm-5 text-left fade_text animate__animated animate__fadeOut animate__slow  mb-4 mb-sm-0">
    ...
    <div class="content">
          <div class="row mb-5 observer_4">
            <div class="col-xs-12 col-sm-4  text-center">
                ...
                <img src="{{ asset('/images/v4.jpg') }}" class="w-100 h-100 rounded-circle" style="object-fit: cover" alt="Third slide">
                    </div>
            </div>
