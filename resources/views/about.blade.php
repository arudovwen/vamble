            ...
            <div class="row">
                ...
                <div class="col-sm-6 bg-white p-5 text-left">
                    ...
                    <p class="about-text">Vamble Apartment & Suites Limited is a renowned lodging facility built just
                        like home to ensure a wonderful and comfortable experience.
                        The Standard and Luxury Apartments are fully furnished with exquisite sitting room, kitchen and
                        bedroom furniture; to ensure you have every homely feel during your stay.

                    </p>
                </div>
                <div class="col-sm-12 bg-white p-5">
                    <p class="about-text">It is situated at …. Abuja and it is easily accessible and available to
                        provide a luxurious and comfortable housing for as long as you please.</p>
