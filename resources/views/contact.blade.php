        ...
        <div class="col-md-6 px-4 text-left d-flex align-items-center">
         ...
         <form action="" method="post" class="w-100">
            ...
            <div class="form-group">
              ...
              <input type="email"
                class="form-control" name="email" id="email" aria-describedby="helpId" placeholder="Enter your email address">

            </div>
              <div class="form-group">
              <label for="">Message</label>
              <textarea
                class="form-control" name="message" id="message" aria-describedby="helpId" placeholder="Write your message here">
              </textarea>
            </div>
